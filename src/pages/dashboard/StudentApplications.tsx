  ...
  return (
    <div className="min-h-screen bg-zinc-50 p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-semibold tracking-tight">My Applications</h1>
        ...
        {applications.length === 0 ? (
          ...
          <div className="grid gap-6">
            {applications.map((app) => (
              <div key={app.id} className="bg-white rounded-3xl p-8 shadow-sm border border-zinc-100">
                <div className="flex justify-between items-start">
                  ...
                  <span className={`px-5 py-2 text-sm font-medium rounded-full capitalize ${
                ...
                {app.cover_letter && (
                  <div className="mt-8 pt-6 border-t">
                    ...
                    <p className="text-sm leading-relaxed text-zinc-700 bg-zinc-50 p-5 rounded-2xl">
                      {app.cover_letter}
                    </p>
                  </div>
                )}
